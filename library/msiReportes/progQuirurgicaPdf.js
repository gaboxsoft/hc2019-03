...
const progQuirurgicaPdf = (progQuirurgicaBD) => {



  console.log('1.- EN progQuirurgicaPdf->', progQuirurgicaBD);
  ...
  var doc = new pdf({
    ...
    margin: 0,
    info: {
      Title: 'HOJA DE PROGRAMACIÓN QUIRÚGICA: msi-20 v1.0',
  ...
  let imgFormato = path.resolve(__dirname, '../../msiformatos/msi20-1.jpg');
  ...
  let pathCfg = path.join(__dirname, './progQuirurgicaFields.cfg');
  ...
  const fileName = 'MSI20-' + Date.now() + '.pdf';
...
module.exports = progQuirurgicaPdf;
