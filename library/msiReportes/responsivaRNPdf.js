...
const responsivaRNPdf = (responsivaRNBD) => {
  //console.log('1.- EN alta Voluntaria->', responsivaRNBD);

  let rrn = responsivaRNBD;
  //console.log('EN alta Voluntaria->', rrn);
  let paciente = rrn.paciente;
  ...
  var doc = new pdf({
    ...
    margin: 0,
    info: {
      Title: 'RESPONSIVA ALOJAMIENTO MAMÁ-RECIÉN NACIDO: msi-42 v1.0',
  ...
  let imgFormato = path.resolve(__dirname, '../../msiformatos/msi42.jpg');
  ...
  let pathCfg = path.join(__dirname, './responsivaRNFields.cfg');
  ...
  const fileName = 'MSI42-' + Date.now() + '.pdf';
...
module.exports =  responsivaRNPdf;
